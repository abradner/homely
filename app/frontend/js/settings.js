...
addSetting = function (setting, serverUrl, roomId, deviceId) {
    ...
    switch (type) {
        case 'Power':
            settings[settingId] = new Power(setting, serverUrl, roomId, deviceId);
            break;
        case 'Colour':
            settings[settingId] = new Colour(setting, serverUrl, roomId, deviceId);
            break;
        default:
            settings[settingId] = new Setting(setting, serverUrl, roomId, deviceId);
    }
}